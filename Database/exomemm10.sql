...
--
-- Host: localhost    Database: exomemm10
-- ------------------------------------------------------
...
CREATE TABLE `disease2gene` (
  ...
  CONSTRAINT `d2giddisease` FOREIGN KEY (`iddisease`) REFERENCES `exomehg19`.`disease` (`iddisease`),
...
CREATE TABLE `snv` (
  ...
  KEY `af` (`af`),
  KEY `avhet` (`avhet`)
) ENGINE=InnoDB AUTO_INCREMENT=929893 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4247729 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1574183 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `snvsample` (
  ...
  `caller` set('samtools','pindel','exomedepth','gatk') DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=21929017 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
