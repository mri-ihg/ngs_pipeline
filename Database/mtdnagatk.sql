...
--
-- Host: localhost    Database: mtdnagatk
-- ------------------------------------------------------
...
--
-- Table structure for table `TMPDELETE`
--

DROP TABLE IF EXISTS `TMPDELETE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TMPDELETE` (
  `idsample2library` int(11) NOT NULL DEFAULT '0',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cnv` (
  `idcnv` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idsample` int(11) unsigned NOT NULL,
  `chrom` varchar(45) NOT NULL,
  `start` int(11) unsigned NOT NULL,
  `end` int(11) unsigned NOT NULL,
  `class` enum('duplication','deletion') NOT NULL,
  `exonnumber` int(11) unsigned NOT NULL,
  `ratio` float DEFAULT NULL,
  PRIMARY KEY (`idcnv`),
  KEY `idsample` (`idsample`),
  CONSTRAINT `cnv_idsample` FOREIGN KEY (`idsample`) REFERENCES `exomehg19`.`sample` (`idsample`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=27383 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `hg19_coords_mod`
--

DROP TABLE IF EXISTS `hg19_coords_mod`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hg19_coords_mod` (
  `acc_num` varchar(10) NOT NULL DEFAULT '',
  `chromosome` varchar(45) NOT NULL,
  `strand` char(1) DEFAULT NULL,
  `coordSTART` int(11) NOT NULL,
  `coordEND` int(11) DEFAULT NULL,
  `upstreamFLANK` varchar(30) DEFAULT NULL,
  `downstreamFLANK` varchar(30) DEFAULT NULL,
  `ref` varchar(99) DEFAULT NULL,
  `alt` varchar(99) DEFAULT NULL,
  `score` tinyint(3) unsigned DEFAULT NULL,
  PRIMARY KEY (`acc_num`),
  KEY `chrstart` (`chromosome`,`coordSTART`),
  KEY `chrend` (`chromosome`,`coordEND`),
  KEY `hgmdscore` (`score`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `snv` (
  ...
  KEY `af` (`af`),
  KEY `avhet` (`avhet`)
) ENGINE=InnoDB AUTO_INCREMENT=4491007 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6153325 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=352771812 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
