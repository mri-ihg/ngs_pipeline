...
) ENGINE=InnoDB AUTO_INCREMENT=1516532 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=47824 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=308499 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `snv` (
  ...
  KEY `af` (`af`),
  KEY `avhet` (`avhet`)
) ENGINE=InnoDB AUTO_INCREMENT=28201383 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=25624186 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=48477900 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `snvsample` (
  ...
  KEY `filter2` (`idsnv`,`filter`,`mapqual`,`gtqual`),
  KEY `filter3` (`idsnv`,`filter`,`gtqual`,`mapqual`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1741141530 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `snvsampledenovo_old`
--

DROP TABLE IF EXISTS `snvsampledenovo_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `snvsampledenovo_old` (
  `idsnvsample` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=252985539 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
