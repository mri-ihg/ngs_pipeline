...
--
-- Host: localhost    Database: mm10genomegatk
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=82369711 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `snv` (
  ...
  KEY `af` (`af`),
  KEY `avhet` (`avhet`)
) ENGINE=InnoDB AUTO_INCREMENT=4606446 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4168402 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7418571 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=38569711 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sv` (
  ...
  KEY `chromstart` (`chrom`,`start`),
  KEY `chromend` (`chrom`,`end`)
) ENGINE=InnoDB AUTO_INCREMENT=90863 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=861658 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `svsample` (
  ...
  `cnunique` float unsigned DEFAULT NULL COMMENT 'cnvnator: unique',
  ...
  KEY `sv_idsv` (`idsv`)
) ENGINE=InnoDB AUTO_INCREMENT=277604 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
