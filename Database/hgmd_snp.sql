...
--
-- Table structure for table `mutsnp`
--

DROP TABLE IF EXISTS `mutsnp`;
...
CREATE TABLE `mutsnp` (
  ...
  `base` varchar(9) COLLATE utf8_unicode_ci DEFAULT NULL,
  `amino` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `codon` int(11) DEFAULT NULL,
  `tag` enum('DP','FP','DFP','DM','FTV','DBS') COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `acc_num` varchar(12) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
